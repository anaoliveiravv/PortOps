...
function MarkerPopup({
  ...
  return createPortal(
    <div
      className={cn(
        "relative max-w-62 rounded-xl border border-border bg-popover p-3 text-popover-foreground shadow-[0_18px_46px_-26px_rgba(15,23,42,0.38)]",
        className,
      )}
    >
...
function MarkerTooltip({
  ...
  return createPortal(
    <div
      className={cn(
        "pointer-events-none rounded-full bg-foreground px-3 py-1.5 text-xs leading-none text-balance text-background shadow-none",
        className,
      )}
    >
      {children}
